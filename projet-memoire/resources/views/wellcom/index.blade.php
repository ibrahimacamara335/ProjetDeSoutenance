@include("wellcom.menu.menu")
  ...
  <div class="untree_co-hero overlay" style="background-image: url('wellcom/images/image_isi2.jpg');">
        ...
        <div class="col-12">
          ...
          <div class="row justify-content-center ">
            ...
            <div class="col-lg-6 text-center ">
              ...
              <h1 class="mb-4 heading text-white" data-aos="fade-up" data-aos-delay="100">L’ISI, est un établissement leader dans le monde informatique</h1>
      ...
      <div class="row justify-content-between">
        <div class="col-lg-4 mb-5 mb-lg-0">
          ...
          <div class="section-title mb-3" data-aos="fade-up" data-aos-delay="0">
            <h2 class="line-bottom mb-4">Groupe ISI</h2>
          </div>

          <p data-aos="fade-up" data-aos-delay="100">Bacheliers, étudiants ou professionnels,

L’ISI, est un établissement d’enseignement supérieur dont le projet pédagogique permet de transmettre la pluralité des savoirs et les clés de lecture d’un monde fluide pour les futurs cadres.

Notre mission est de bien former les futurs leaders, mais aussi, d’accompagner les étudiants issus de l’ensemble de la population afin que chacun d’eux  puisse avoir la chance de devenir un manager.</p>

        </div>
        <div class="col-lg-6" data-aos="fade-up" data-aos-delay="0">
          <figure class="img-wrap-4">
            <img src="wellcom/images/image_isi4.jpg" alt="Image" class="img-fluid">
    ...
    <div class="container">
      <div class="row justify-content-center mb-3">
        <div class="col-lg-7 text-center" data-aos="fade-up" data-aos-delay="0">
          <h2 class="line-bottom text-center mb-4">NOS PARTENAIRES</h2>
        </div>
      </div>
      <div class="row align-items-stretch">
        <div class="col-sm-6 col-md-6 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="0">
          <a href="#" class="category d-flex align-items-start h-100">
            ...
            <div>
              <img src="wellcom/images/logo-cisco.png" alt="">
            </div>
          </a>
        </div>
        <div class="col-sm-6 col-md-6 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="100">
          <a href="#" class="category d-flex align-items-start h-100">
            ...
            <div>
            <img src="wellcom/images/cames.png" alt="">
            </div>
          </a>
        </div>
        <div class="col-sm-6 col-md-6 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="200">
          <a href="#" class="category d-flex align-items-start h-100">
            ...
            <div>
            <img src="wellcom/images/aws.png" alt="">
            </div>
          </a>
        </div>
        <div class="col-sm-6 col-md-6 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="300">
          <a href="#" class="category d-flex align-items-start h-100">
            ...
            <div>
            <img src="wellcom/images/anaq.png" alt="">
            </div>
          </a>
        </div>
        ...
        <div class="col-sm-6 col-md-6 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="0">
          <a href="#" class="category d-flex align-items-start h-100">
            ...
            <div>
            <img src="wellcom/images/huawei.png" alt="">
            </div>
          </a>
        </div>
        <div class="col-sm-6 col-md-6 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="100">
          <a href="#" class="category d-flex align-items-start h-100">
            ...
            <div>
            <img src="wellcom/images/oracle.png" alt="">
            </div>
          </a>
        </div>
        <div class="col-sm-6 col-md-6 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="200">
          <a href="#" class="category d-flex align-items-start h-100">
            ...
            <div>
            <img src="wellcom/images/Captureee-1.png" alt="">
            </div>
          </a>
        </div>
        <div class="col-sm-6 col-md-6 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="300">
          <a href="#" class="category d-flex align-items-start h-100">
            ...
            <div>
            <img src="wellcom/images/3fpt.png" alt="">
            </div>
          </a>
        </div>
      ...
      <div class="row">
        <div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-4 mb-lg-0">
          <div class="custom-media">
            <a href="#"><img src="wellcom/images/img-school-1-min.jpg" alt="Image" class="img-fluid"></a>
      ...
      <div class="row align-items-stretch">
        <div class="col-lg-6"  data-aos="fade-up" data-aos-delay="100">
          <div class="media-h d-flex h-100">
            <figure>
              <img src="wellcom/images/img-school-1-min.jpg" alt="Image">
            </figure>
        ...
        <div class="col-lg-6"  data-aos="fade-up" data-aos-delay="200">
          <div class="media-h d-flex h-100">
            <figure>
              <img src="wellcom/images/img-school-2-min.jpg" alt="Image">
            </figure>
            <div class="media-h-body">
          ...
          <div class="owl-carousel wide-slider-testimonial">
            <div class="item">
              <blockquote class="block-testimonial">
                ...
                <div class="author">
                  <img src="wellcom/images/person_1.jpg" alt="Free template by TemplateUX">
                  <h3>John Doe</h3>
            ...
            <div class="item">
              <blockquote class="block-testimonial">
                ...
                <div class="author">
                  <img src="wellcom/images/person_2.jpg" alt="Free template by TemplateUX">
            ...
            <div class="item">
              <blockquote class="block-testimonial">
                ...
                <div class="author">
                  <img src="wellcom/images/person_3.jpg" alt="Free template by TemplateUX">
                  <h3>Rob Smith</h3>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-5 mr-auto mb-5 mb-lg-0"  data-aos="fade-up" data-aos-delay="0">
          <img src="wellcom/images/img-school-5-min.jpg" alt="image" class="img-fluid">
        </div>
                ...
                <div class="accordion-body">
                  <div class="d-flex">
                    <div class="accordion-img mr-4">
                      <img src="wellcom/images/img-school-1-min.jpg" alt="Image" class="img-fluid">
                    </div>
                    <div>
                      <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. </p>
            ...
            <div class="accordion-item">
              ...
              <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion_1">
                <div class="accordion-body">
                  <div class="d-flex">
                    <div class="accordion-img mr-4">
                      <img src="wellcom/images/img-school-2-min.jpg" alt="Image" class="img-fluid">
                    </div>
                    <div>
                      <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. </p>
                      <p>Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p>
